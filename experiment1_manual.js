// Experiment 1: Smell Manual Test Configuration
const experimentConfig = {
    experimentType: "smell_manual",
    experimentName: "Experiment 1 - Smell Manual Test",
    phases: {
        smell: {
            name: "Smell Phase",
            stimuli: [
...
function downloadResults() {
    ...
    link.download = `experiment1_smell_manual_participant${currentParticipant}_${new Date().toISOString().split('T')[0]}.json`;
    link.click();
}
